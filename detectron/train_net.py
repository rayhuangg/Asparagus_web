...
class Trainer(DefaultTrainer):
    ...
    def build_train_loader(cls, cfg):
        return build_detection_train_loader(cfg, mapper=DatasetMapper(cfg, is_train=True, augmentations=[
            T.ResizeShortestEdge(short_edge_length=(864, 896, 928, 960, 992, 1024), max_size=1333, sample_style='choice'),
            T.RandomFlip(),
...
def main(args):
    register_coco_instances('asparagus_train', {'_background_': 0, 'clump': 1, 'stalk': 2, 'spear': 3} , "./datasets/coco/annotations/train/annotations.json", "./datasets/coco/annotations/train")
